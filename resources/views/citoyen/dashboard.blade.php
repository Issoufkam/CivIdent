...
<main class="container py-5">
            ...
            <div class="col-md-8">
                <div class="card p-4">
                    ...
                    <ul class="nav nav-tabs mb-4" id="docTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#naissance">
                                Extrait de naissance
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#mariage">
                                Acte de mariage
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#Certifdevie">
                                Certificat de vie
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#Celibat">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="Certifdevie">
                            <p class="text-muted text-center py-4">Aucune demande pour l'instant.</p>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card document-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../formulaire_demande/acte_naissance.html" class="btn btn-outline-success w-100">Demander</a>
                        </div>
                    </div>
                </div>
        ...
        <section>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card document-card h-100">
                        <img src="../img/dossier 1.jpeg" 
                             alt="Certification de résidence" 
                             class="card-img-top">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card document-card h-100">
                        <img src="../img/doc 6.jpeg" 
                             alt="Certification de célibat" 
                             class="card-img-top">
                        <div class="card-body">
